...
export const description: INodeProperties[] = [
	{
		...
		default: '',
		required: true,
		description: 'First name of the contactable',
		displayOptions: showFor('contactPerson', 'createContactable'),
	},
	{
		...
		default: '',
		required: true,
		description: 'Last name of the contactable',
		displayOptions: showFor('contactPerson', 'createContactable'),
	},
	{
		...
		default: {},
		description: 'Optional fields of the contactable',
		displayOptions: showFor('contactPerson', 'createContactable'),
		options: [
			{
				...
				type: 'string',
				default: '',
				description: 'Academic title of the contactable, e.g. Dr',
			},
			{
				...
				description: 'Birth date of the contactable',
			},
			{
				displayName: 'Email',
				name: 'email',
			...
			},
			{
				...
				type: 'string',
				default: '',
				description: 'Salutation of the contactable, e.g. Frau or Herr',
			},
		],
	},
	contactDataProperty('contactPerson', 'createContactable'),
];
...
export async function execute(
	...
	return (data.createContactable as IDataObject) ?? null;
}
